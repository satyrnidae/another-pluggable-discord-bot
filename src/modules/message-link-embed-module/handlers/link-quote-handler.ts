...
import { MessageEventHandler } from '/src/api/module';
import { lazyInject } from '/src/api/inversion';
import { ServiceIdentifiers, ClientService } from '/src/api/services';
import { ModuleServiceIdentifiers, ModuleConfigurationService, MessageService } from '/src/modules/message-link-embed-module/services';
import { MessageHistoryFactory } from '/src/modules/message-link-embed-module/db/factory';
import { MessageLinkHistory } from '/src/modules/message-link-embed-module/db/entity';
...
export class LinkQuoteHandler extends MessageEventHandler {
